...
![Главное окно](screenshots/главный%20экран.png)
...
![Экран документа](screenshots/экран%20документа%20распознавание%20текста.png)
*Экран приёмки с загруженным документом и предпросмотром*

![OCR результаты](screenshots/список%20товаров%20из%20документа.png)
*Результаты распознавания с цветовой индикацией уверенности*
...
![Видеозапись](screenshots/основной%20экран%20приема%20видео%20и%20фото%20фиксация.png)
...
![Входной контроль](screenshots/пошаговые%20инструкции%20проверки.png)
...
![Загрузка](screenshots/экран%20документа%20распознавание%20текста.png)
...
### Шаг 3: Запуск OCR
![OCR](screenshots/экран%20документа%20распознавание%20текста.png)
...
![Результаты](screenshots/список%20товаров%20из%20документа.png)
Проверьте данные. Цветовая индикация:
- 🟢 Зелёный - достоверны
- 🟡 Жёлтый - проверьте
- 🔴 Красный - исправьте
...
![Контроль](screenshots/пошаговые%20инструкции%20проверки.png)
Запустите видеозапись и следуйте инструкциям

</td>
<td width="50%">

### Шаг 6: Принятие решения
![Принятие](screenshots/основной%20экран%20приема%20видео%20и%20фото%20фиксация.png)
Примите или отклоните товар, добавьте комментарий
...
![Статусы](screenshots/основной%20экран%20приема%20видео%20и%20фото%20фиксация.png)
Все товары отмечены: ✅ Принято, ❌ Отклонено, ⏳ Ожидает

</td>
<td width="50%">

### Шаг 8: Просмотр истории
![История](screenshots/экран%20история%20приемок.png)
...
Система протестирована на различных форматах документов:

![Примеры документов](screenshots/примеры%20документов%20для%20тестирования.png)
*Примеры тестовых документов - поддерживаются форматы PDF и изображения (JPG, PNG)*

### Поддерживаемые форматы
- ✅ **PDF** - с живым текстом и отсканированные
- ✅ **Изображения** - JPG, PNG
- ✅ **Рукописные пометки** - с использованием LLM-анализа

---

## 📤 Процесс завершения приёмки

После проверки всех товаров данные отправляются на сервер:

![Отправка на сервер](screenshots/отправка%20итогов%20на%20сервер.png)
*Финальный экран отправки результатов приёмки на сервер*

Система автоматически:
- ✅ Сохраняет все данные в БД
- ✅ Загружает документы на сервер
- ✅ Сохраняет видео входного контроля
- ✅ Привязывает фотографии к товарам
